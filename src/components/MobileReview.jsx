  ...
  return (
    <section id="mobile-reviews">
      <div className="max-w-6xl px-5 mx-auto mt-20 text-center relative md:hidden">
        ...
        <div className="flex flex-col mt-20 md:flex-row transition-all duration-1000 ease-linear md:space-x-5" onTouchStart={handleTouchStart} onTouchMove={handleTouchMove} >
